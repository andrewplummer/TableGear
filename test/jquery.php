...
// -- Primary Key
//
// For you performance nuts, this option will save a query by specifying the
// primary key field in advance. Note that this won't work for composite primary keys.

// $options["database"]["key"] = "id";
...
//$options["formatting"]  = array("memory" => "memory[auto]", "date" => "date", "number" => "numeric");
